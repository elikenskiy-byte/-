[index.html](https://github.com/user-attachments/files/28033243/index.html)
<!DOCTYPE html>
<html lang="uk">
<head>
    <meta charset="UTF-8">
...
function generateRecipe() {
    ...
    setTimeout(function() {
        ...
        var MethodsUA = [
            "Дрібно наріжте", "Шаткуйте соломкою", "Перебийте в блендері", 
            "Слайсуйте тонкими шматочками", "Обпаліть пальником та подрібніть"
        ];
        var MethodsEN = [
            "Finely chop", "Shred into strips", "Blend until smooth", 
            "Slice into thin pieces", "Sear with a torch and crush"
        ];
