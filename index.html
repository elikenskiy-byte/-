[index.html](https://github.com/user-attachments/files/28031852/index.html)
<!DOCTYPE html>
<html lang="uk">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        function generateRecipe() {
            ...
            setTimeout(function() {
                ...
                if (activeLang === 'uk') {
                    title = '🤖 ЕКСКЛЮЗИВ ВІД CHATGPT:';
                    ingTitle = 'ІНГРЕДІЄНТИ:';
                    stepTitle = 'КРОКИ ПРИГОТУВАННЯ:';
                    oilText = '• Оливкова олія — 20мл';
                    steps = [
                        '1. Ретельно промийте та наріжте ',
                        '2. Обсмажте на сковороді з додаванням олії 15 хвилин.',
                        '3. Додайте секретний кібер-соус та подавайте страву гарячою!'
                    ];
                } else if (activeLang === 'ru') {
                    title = '🤖 ЭКСКЛЮЗИВ ОТ CHATGPT:';
                    ingTitle = 'ИНГРЕДИЕНТЫ:';
                    stepTitle = 'ШАГИ ПРИГОТОВЛЕНИЯ:';
                    oilText = '• Оливковое масло — 20мл';
                    steps = [
                        '1. Тщательно промойте и нарежьте ',
                        '2. Обжарьте на сковороде с добавлением масла 15 минут.',
                        '3. Добавьте секретный кибер-соус и подавайте блюдо горячим!'
                    ];
                } else {
                    title = '🤖 EXCLUSIVE BY CHATGPT:';
                    ingTitle = 'INGREDIENTS:';
                    stepTitle = 'COOKING STEPS:';
                    oilText = '• Olive oil — 20ml';
                    steps = [
                        '1. Wash and slice all ',
                        '2. Fry them with olive oil for 15 minutes.',
                        '3. Add cyber sauce and serve hot!'
                    ];
                }
